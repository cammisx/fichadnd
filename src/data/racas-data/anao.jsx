const anao = {
  id: "anao",
  nome: "Anão",
tituloCriacao: "Criando um Anão",

  visaoGeral: {
    quote: `"ESTÁ ATRASADO, ELFO!", o drow ouviu o tom áspero de uma voz familiar. Bruenor Martelo de Batalha subiu pelas costas do adversário morto, desconsiderando o fato de que o pesado monstro jazia sobre seu amigo élfico. Apesar desse novo desconforto, o nariz grande, pontudo e várias vezes quebrado do anão — bem como sua barba vermelha, raiada de branco, mas ainda cor de fogo — surgiu como uma visão agradável para Drizzt. "Eu sabia que ia te encontrar encrencado se saísse para te procurar!"
...
Os anões são determinados e leais, fiéis à sua palavra e decididos quando agem, às vezes a ponto de serem teimosos. Muitos anões têm um forte senso de justiça e demoram a se esquecer de erros cometidos contra eles. Uma injustiça cometida contra um anão é uma ofensa para todo seu clã. O que começa como uma busca por vingança de um único anão, pode se tornar a ambição de todo um clã.`
    },
    {
      titulo: "CLÃS E REINOS",
      texto: `Os reinos anões estendem-se pelas profundezas das montanhas, onde eles mineram gemas e metais preciosos, e forjam itens admiráveis. Eles amam a beleza e a arte dos metais preciosos e das joias finas e, em alguns anões, esse amor transforma-se em avareza. O que não pode ser encontrado em suas montanhas, eles adquirem através do comércio. Eles não gostam de barcos, embora os comerciantes humanos e halflings lidem frequentemente com o comércio de bens anões por rotas marítimas. Membros de confiança de outras raças são bem-vindos em assentamentos anões, embora algumas áreas dessas cidades sejam vetadas até mesmo para eles.
...
Anões em outras terras são tipicamente artesãos, geralmente ferreiros, armeiros e joalheiros. Alguns são mercenários ou guarda-costas, procurados pela sua coragem e lealdade, e bem recompensados por seus serviços.`
  ...
  criacao: {
    ...
    habilidades: [
      {
        ...
        descricao: "Acostumado à vida subterrânea, você tem visão superior no escuro..."
      },
      {
        nome: "Resiliência Anã",
        descricao: "Você possui vantagem em testes de resistência contra veneno..."
      }
    ],
    ...
    subracas: [
      {
        nome: "Anão da Colina",
        descricao: "Os anões da colina são resistentes e sábios...",
        modificadores: "+2 Sabedoria",
        habilidades: "Tenacidade Anã"
      },
      {
        nome: "Anão da Montanha",
        descricao: "Fortes e robustos, os anões da montanha...",
        modificadores: "+2 Força",
        habilidades: "Treinamento em Armaduras Anãs"
      }
    ]
  }
}
